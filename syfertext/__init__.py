...
def load(model_name: str) -> Language:
    ...
    nlp.load_pipeline(
        pipeline_template=language_model.pipeline_template, states=language_model.states
    )

    return nlp


def create(model_name, tags: Set[str] = None, description: str = None):
    ...
    # Instantiate a Language object
    nlp = Language(model_name=model_name, owner=LOCAL_WORKER, tags=tags, description=description)
