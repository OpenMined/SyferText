...
class Tokenizer(AbstractObject):
    ...
    def _split_affixes(self, substring: str, start_pos: int)-> Tuple[str, int, List[TokenMeta],
         List[TokenMeta], List[TokenMeta], List[TokenMeta]]:
