...
setup(
    ...
    install_requires=["tqdm==4.36.1", "mmh3==2.5.1", "syft-master", "requests==2.22.0"],
    extras_require={
        "test": [
            "black>=19.10b0",
            "pytest>=5.3.5",
    ...
    dependency_links=[
        "git+https://github.com/OpenMined@328de40c21054575955595dc72f7a4ce9065afc7#egg=syft-master"
    ],
)
